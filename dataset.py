...
class MolsDataset(Dataset):
    ...
    def __init__(self, data_dir: str) -> None:
        ...
        # self.files = self.files[:9999] + self.files[21080:21100]

        # self.files.remove("269865.pkl.pth")
        # self.files.remove("16077.pkl.pth")

        # self.files = self.files[:9999] + ['269865.pkl.pth']
